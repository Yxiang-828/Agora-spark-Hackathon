...
const Codespace = makeAsyncComponent('Codespace', lazy(() => import('components/codespace')),
    (
        <div className='app__content'>
            <LoadingScreen/>
        </div>
...
const AgoraWorkspace = makeAsyncComponent('AgoraWorkspace', lazy(() => import('components/agora')),
    (
        <div className='app__content'>
            <LoadingScreen/>
        </div>
            ...
            >
                ...
                <div className='row main'>
                    <Switch>
                        ...
                        <Route
                            path={`/:team(${TEAM_NAME_PATH_PATTERN})/codespace`}
                            component={Codespace}
                        />
                        <Route
                            path={`/:team(${TEAM_NAME_PATH_PATTERN})/agora`}
                            component={AgoraWorkspace}
                        />
                        <Route
