...
const CodespaceLink = makeAsyncComponent('CodespaceLink', lazy(() => import('components/codespace_link/codespace_link')));
const AgoraLink = makeAsyncComponent('AgoraLink', lazy(() => import('components/agora_link/agora_link')));
