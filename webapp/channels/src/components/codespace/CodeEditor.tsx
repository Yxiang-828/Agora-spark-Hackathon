...
import {EditorView, GutterMarker, gutter, keymap, ViewUpdate, BlockInfo} from '@codemirror/view';
...
const commentGutter = (lines: Set<number>) => gutter({
    ...
    lineMarker: (view: EditorView, block: BlockInfo) => (lines.has(view.state.doc.lineAt(block.from).number) ? new CommentMarker() : null),
});
