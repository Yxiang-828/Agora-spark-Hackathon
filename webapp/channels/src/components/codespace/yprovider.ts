...
// Native Agora codespace: the collaborative IDE is now a first-class surface in the app,
// but the doc-sync/storage backend is still the Agora plugin's HTTP API + WS relay. This is
// the plugin id we address (formerly read from the plugin's `manifest`).
export const PLUGIN_ID = 'com.aegis.agora';
