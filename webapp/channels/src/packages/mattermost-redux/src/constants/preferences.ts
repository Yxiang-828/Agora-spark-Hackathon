...
const Preferences = {
    ...
    THEMES: {
        denim: {
            // Agora — default dark theme (googogooagaga palette). Keyed as "denim"
            // so it remains the product default without touching selection logic.
            type: 'Agora',
            sidebarBg: '#0a0c10',
            sidebarText: '#c6cad2',
            sidebarUnreadText: '#ffffff',
            sidebarTextHoverBg: '#1a1d24',
            sidebarTextActiveBorder: '#5d89ea',
            sidebarTextActiveColor: '#ffffff',
            sidebarHeaderBg: '#0f1115',
            sidebarHeaderTextColor: '#ffffff',
            sidebarTeamBarBg: '#08090c',
            ...
            mentionBj: '#5d89ea',
            mentionColor: '#ffffff',
            centerChannelBg: '#15171c',
            centerChannelColor: '#c6cad2',
            newMessageSeparator: '#5d89ea',
            linkColor: '#5d89ea',
            buttonBg: '#166de0',
            buttonColor: '#ffffff',
            errorTextColor: '#fd5960',
            mentionHighlightBg: '#26303f',
            mentionHighlightLink: '#8fb4ff',
            codeTheme: 'monokai',
        },
        agoraLight: {
            // Agora — light counterpart of the default dark theme (header sun/moon toggle).
            type: 'Agora Light',
            sidebarBg: '#f4f5f7',
            sidebarText: '#3f4350',
            sidebarUnreadText: '#1b1d22',
            sidebarTextHoverBg: '#e7e9ee',
            sidebarTextActiveBorder: '#166de0',
            sidebarTextActiveColor: '#1b1d22',
            sidebarHeaderBg: '#ffffff',
            sidebarHeaderTextColor: '#1b1d22',
            sidebarTeamBarBg: '#e7e9ee',
            onlineIndicator: '#3db887',
            awayIndicator: '#ffbc42',
            dndIndicator: '#d24b4e',
            mentionBg: '#166de0',
            ...
            newMessageSeparator: '#166de0',
            linkColor: '#166de0',
            buttonBg: '#166de0',
            buttonColor: '#ffffff',
            errorTextColor: '#d24b4e',
            mentionHighlightBg: '#ffe8a8',
            mentionHighlightLink: '#0b5cbe',
            codeTheme: 'github',
        },
        sapphire: {
            type: 'Sapphire',
        ...
        neonPixel: {
            // Agora — Neon Pixel. A retro-arcade theme: void background, neon magenta/cyan/green
            // accents. The pixel font + glow + sharp edges are layered on by sass/components/
            // _agora-pixel.scss, gated on body.agora-theme-pixel (set in utils.applyTheme).
            type: 'Neon Pixel',
            sidebarBg: '#0a0612',
            sidebarText: '#8be9fd',
            sidebarUnreadText: '#ffffff',
            sidebarTextHoverBg: '#1a0f2e',
            sidebarTextActiveBorder: '#ff2e97',
            sidebarTextActiveColor: '#ffffff',
            sidebarHeaderBg: '#120726',
            sidebarHeaderTextColor: '#ff2e97',
            sidebarTeamBarBg: '#070310',
            onlineIndicator: '#39ff14',
            awayIndicator: '#fffb00',
            dndIndicator: '#ff2e97',
            mentionBg: '#ff2e97',
            mentionBj: '#ff2e97',
            mentionColor: '#ffffff',
            centerChannelBg: '#0d0a16',
            centerChannelColor: '#d6e7ff',
            newMessageSeparator: '#00e5ff',
            linkColor: '#00e5ff',
            buttonBg: '#ff2e97',
            buttonColor: '#ffffff',
            errorTextColor: '#ff5277',
            mentionHighlightBg: '#2a0a3f',
            mentionHighlightLink: '#39ff14',
            codeTheme: 'monokai',
        },
