...
// Source: github.com/aegis/agora/server/command (interfaces: Command)
//
// Generated by this command:
//
//	mockgen -destination=server/command/mocks/mock_commands.go -package=mocks github.com/aegis/agora/server/command Command
//
